...
def TrackImages():
    ...
    if exists1:
        ...
        mess._show(title='Details Missing', message='login details are missing, please check!')
        cam.release()
        cv2.destroyAllWindows()
        window.destroy()
    while True:
...
def show_successful_login():
    ...
    success_label = tk.Label(new_window, text="Successfully Logged In!", bg="white", font=('comic', 14, 'bold'))
    success_label.pack(pady=20)

    ok_button = tk.Button(new_window, text="OK", command=new_window.destroy, bg="#3ffc00", font=('comic', 12, 'bold'))
    ok_button.pack()
...
message3 = tk.Label(window, text="     Login to your zerver" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
lbl2 = tk.Label(frame2, text="Enter password",width=20  ,fg="black"  ,bg="#c79cff" ,font=('comic', 17, ' bold '))
...
lbl3 = tk.Label(frame1, text="ZERVER LOGGED IN DETAILS",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('comic', 17, ' bold '))
...
trackImg = tk.Button(frame1, text="LOGIN TO ZERVER", command=TrackImages  ,fg="black"  ,bg="#3ffc00"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
